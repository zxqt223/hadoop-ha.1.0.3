...
public class TestStreaming extends TestCase
{
  ...
  protected String[] genArgs() {
    return new String[] {
      "-input", "/user/junwu.xiong/ef2fof",
      "-output", "ef2fof_output",
      "-mapper", map,
      "-reducer", reduce,
      //"-verbose",
      //"-jobconf", "stream.debug=set"
      //"-jobconf", "keep.failed.task.files=true",
      //"-jobconf", "stream.tmpdir="+System.getProperty("test.build.data","/Users/zhangscott/Workspace/hadoop-1.0.3/conf")
    };
  }
