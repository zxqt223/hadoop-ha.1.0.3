...
public class DFSClient implements FSConstants, java.io.Closeable {
  ...
  private static ClientProtocol createRPCNamenode(InetSocketAddress nameNodeAddr,
    ...
    throws IOException {
    return (ClientProtocol)RPC.getNameNodeHAProxy(ClientProtocol.class,
  ...
  /**@ADDCODE xianquan.zhang support override this method in child class.we can use this method at child class NoretryDFSClient */
  protected ClientProtocol createClientProtocol(ClientProtocol rpcNamenode)
    throws IOException {
    return createNamenode(rpcNamenode);
  }
  /**@ADDCODE xianquan.zhang support override this method in child class.we can use this method at child class NoretryDFSClient */
  ...
  DFSClient(InetSocketAddress nameNodeAddr, ClientProtocol rpcNamenode,
    ...
    if (nameNodeAddr != null && rpcNamenode == null) {
      /**@CHANGECODE xianquan.zhang(2012-11-16) support clild class override createClientProtocol method*/
      this.rpcNamenode = createRPCProxy(nameNodeAddr, conf, ugi);
      this.namenode = createClientProtocol(this.rpcNamenode);
