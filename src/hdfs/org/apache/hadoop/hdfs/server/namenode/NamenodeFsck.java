...
public class NamenodeFsck {
  ...
  NamenodeFsck(Configuration conf, NameNode namenode,
    ...
    for (Iterator<String> it = pmap.keySet().iterator(); it.hasNext();) {
      ...
      /**@ADDCODE xianquan.zhang*/
      else if (key.equals("listcorruptfiles")) {
  ...
  /**@ADDCODE xianquan.zhang surpport list-corrupt files*/
  private void listCorruptFiles() throws IOException {
	    Collection<FSNamesystem.CorruptFileBlockInfo> corruptFiles = namenode
	      .getNamesystem().listCorruptFiles(path, currentCookie);
